...
var _ishop = __webpack_require__(18);

var _ishop2 = _interopRequireDefault(_ishop);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var goods = __webpack_require__(24);

_reactDom2.default.render(_react2.default.createElement(_ishop2.default, { goods: goods }), document.getElementById('container'));
...
var _ishop3Products = __webpack_require__(22);

var _ishop3Products2 = _interopRequireDefault(_ishop3Products);
...
var IShop3 = function (_React$Component) {
    ...
    function IShop3() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = IShop3.__proto__ || Object.getPrototypeOf(IShop3)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
            ...
            selected: null
        }, _this.selectFunction = function (id) {
            if (_this.state.selected === id) {
                _this.setState({ selected: null });
            } else {
                _this.setState({ selected: id });
            }
        }, _this.deletingFunction = function (code) {
            if (confirm('Удалить?')) {
                _this.state.goods.splice(code, 1);
                _this.setState({ goods: _this.state.goods });
            }
    ...
    _createClass(IShop3, [{
        ...
        value: function render() {
            ...
            var products = this.state.goods.map(function (v, i) {
                return _react2.default.createElement(_ishop3Products2.default, { name: v.name,
                    price: v.price,
                    quantity: v.quantity,
                    img: v.img,
                    id: v.id,
                    arrayCode: i,
                    selectedID: _this2.state.selected,
                    delFunc: _this2.deletingFunction,
                    selectFunc: _this2.selectFunction
                });
            });
            return _react2.default.createElement(
                'div',
                { className: 'shop__wrapper' },
                ' ',
                products,
                ' '
            );
...
IShop3.propTypes = {
    goods: _propTypes2.default.array.isRequired
};
...
var Products = function (_React$Component) {
    ...
    function Products() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Products.__proto__ || Object.getPrototypeOf(Products)).call.apply(_ref, [this].concat(args))), _this), _this.highLightSelected = function () {
            _this.props.selectFunc(_this.props.id);
        }, _this.deleting = function () {
            _this.props.delFunc(_this.props.arrayCode);
        }, _temp), _possibleConstructorReturn(_this, _ret);
    }
    ...
    _createClass(Products, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                { className: 'product__wrapper' + (this.props.selectedID === this.props.id ? ' selected' : ''), onClick: this.highLightSelected },
                _react2.default.createElement('img', { className: 'product__img', src: this.props.img }),
                ...
                _react2.default.createElement('input', { type: 'button', className: 'product__delete-button', value: '\u0423\u0434\u0430\u043B\u0438\u0442\u044C', onClick: 'this.deleting' })
            );
        }
    }]);
...
Products.propTypes = {
    ...
    arrayCode: _propTypes2.default.number.isRequired,
    delFunc: _propTypes2.default.func,
    selectFunc: _propTypes2.default.func,
...
module.exports = [{"id":65486,"name":"M4A1-S","price":3100,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/M4a1-s.png","quantity":33},{"id":54852,"name":"AK-47","price":2700,"img":"http://mircsgo.ru/wp-content/uploads/2014/11/Ak47go.png","quantity":36},{"id":95485,"name":"M4A4","price":3100,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/M4a4.png","quantity":33},{"id":32548,"name":"Galil AR","price":2000,"img":"http://mircsgo.ru/wp-content/uploads/2015/04/Galilar.png","quantity":30},{"id":32584,"name":"FAMAS","price":2250,"img":"http://mircsgo.ru/wp-content/uploads/2015/04/Famasgo.png","quantity":30},{"id":48562,"name":"AUG","price":3300,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/Auggo.png","quantity":28},{"id":67485,"name":"SG 553","price":3000,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/Sg556.png","quantity":30},{"id":95486,"name":"SSG 08","price":1700,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/Ssg08.png","quantity":88},{"id":85256,"name":"S3SG1","price":5000,"img":"http://mircsgo.ru/wp-content/uploads/2015/04/G3.png","quantity":80},{"id":55845,"name":"SCAR-20","price":5000,"img":"http://mircsgo.ru/wp-content/uploads/2015/04/Scar20.png","quantity":80},{"id":32541,"name":"AWP","price":4750,"img":"http://mircsgo.ru/wp-content/uploads/2015/03/Awpgo.png","quantity":115}]
